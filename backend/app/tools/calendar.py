...
events: list[CalendarEvent] = [
    ...
    CalendarEvent(
        ...
        starts_at="2026-05-30T10:00:00+02:00",
        ends_at="2026-05-30T11:30:00+02:00",
        location="Brussels",
    ...
    CalendarEvent(
        id="evt_003",
        title="Leo rehearsal",
        starts_at="2026-05-30T13:00:00+02:00",
        ends_at="2026-05-30T15:00:00+02:00",
        location="Brussels",
    ...
    CalendarEvent(
        ...
        starts_at="2026-05-30T16:00:00+02:00",
        ends_at="2026-05-30T17:00:00+02:00",
        location="Antwerp",
    ...
    CalendarEvent(
        ...
        ends_at="2026-05-31T23:00:00+02:00",
        location="Bruges",
        attendees=["c_006", "Tom Jacobs"],
    ),
    CalendarEvent(
        id="evt_006",
        title="Aisha research sync",
        starts_at="2026-05-31T16:00:00+02:00",
        ends_at="2026-05-31T23:00:00+02:00",
        location="Ghent",
        attendees=["c_003", "Aisha Khan"],
    ),
    CalendarEvent(
        id="evt_007",
        title="Bram operations handoff",
        starts_at="2026-05-31T16:00:00+02:00",
        ends_at="2026-05-31T23:00:00+02:00",
        location="Antwerp",
        attendees=["c_008", "Bram De Smet"],
    ),
    CalendarEvent(
        id="evt_008",
        title="Eleni study group",
        starts_at="2026-05-31T16:00:00+02:00",
        ends_at="2026-05-31T23:00:00+02:00",
        location="Leuven",
        attendees=["c_009", "Eleni Costa"],
    ),
    CalendarEvent(
        id="evt_009",
        title="Oscar club night",
        starts_at="2026-05-31T16:00:00+02:00",
        ends_at="2026-05-31T23:00:00+02:00",
        location="Namur",
        attendees=["c_011", "Oscar Dubois"],
    ),
    CalendarEvent(
        id="evt_010",
        title="Priya research review",
        starts_at="2026-05-31T16:00:00+02:00",
        ends_at="2026-05-31T23:00:00+02:00",
        location="Ghent",
        attendees=["c_012", "Priya Nair"],
    ),
]
