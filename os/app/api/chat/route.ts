...
const BASE_INSTRUCTIONS = [
  ...
  "Before adding a bridge, you may call `canvas_preview_bridge` to verify port compatibility and inspect what the target would receive. If preview says the transform is unknown or incompatible, pick another existing transform or skip the bridge.",
