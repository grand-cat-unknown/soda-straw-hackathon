...
const BASE_INSTRUCTIONS = [
  ...
  "Backend-backed widgets should include `bindings` and `actions`. A binding is `{ capabilityId, params, resultPath, transform, refresh }` keyed by the widget input port it fills. Use `refresh: 'onMount'` when the widget should load from the backend by itself.",
